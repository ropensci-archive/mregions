...
50 features are loaded, therefore the result differs from the map available on the [geoserver](http://geo.vliz.be/geoserver/Ecoregions/wms?service=WMS&version=1.1.0&request=GetMap&layers=Ecoregions:ecoregions&styles=&bbox=-180.0,-89.9,180.0,86.919&width=768&height=377&srs=EPSG:4326&format=application/openlayers).

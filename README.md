...
```r
res1 <- region_geojson(name = "Turkmen Exclusive Economic Zone")
```
...
```r
res2 <- region_shp(name = "Belgian Exclusive Economic Zone")
```
...
```r
res3 <- region_geojson(key = "MarineRegions:eez_33176")
as_wkt(res3, fmt = 5)
